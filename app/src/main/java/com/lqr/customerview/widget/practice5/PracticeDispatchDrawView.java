...
public class PracticeDispatchDrawView extends LinearLayout {
    ...
    public PracticeDispatchDrawView(Context context) {
        this(context, null);
    }

    public PracticeDispatchDrawView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PracticeDispatchDrawView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
