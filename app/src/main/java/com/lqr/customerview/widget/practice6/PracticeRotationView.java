...
public class PracticeRotationView extends RelativeLayout {
    ...
    public PracticeRotationView(Context context) {
        super(context);
    }

    public PracticeRotationView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PracticeRotationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
